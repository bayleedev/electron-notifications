...
class Notifier {
  ...
  showIfPending () {
    ...
    if(!(this.activeNotifications < this.maxStack)) {
    	//TODO - enqueue until the next close
    	//return;
    }
    ...
    //  TODO - we have a lot of visible space between notifications - fix this
    ...
    notificationWindow.on('closed', () => {
      // TODO - do a pretty slide up/down to collapse list gaps if a notification in the middle closes out of order with others
